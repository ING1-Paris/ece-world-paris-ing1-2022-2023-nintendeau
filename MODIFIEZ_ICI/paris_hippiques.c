...
int main() {
    ...
    SAMPLE *music = load_wav("../son/accueil.wav");
    play_sample(music, 255, 128, 1000, 1); //permet de jouer de la musique en boucle

    set_gfx_mode(GFX_AUTODETECT_WINDOWED, SCREEN_W, SCREEN_H, 0 , 0);

    BITMAP *accueil = load_bitmap("../images/accueil.bmp",NULL); //création d'un bitmap
    BITMAP *choixjoueur1 = load_bitmap("../images/choixjoueur1.bmp",NULL);
    ...
    BITMAP *choixjoueur2 = load_bitmap("../images/choixjoueur2.bmp",NULL);
    ...
    if (key[KEY_ENTER]){
        ...
        SAMPLE *music2 = load_sample("../son/course1.wav"); //chargement de la musique de course
        if (!music2) {
        ...
        textprintf_ex(page, font, SCREEN_W/2, SCREEN_H/2, makecol(255, 255, 255), -1, "3");
        blit(page, screen, 0, 0, 0, 0, SCREEN_W, SCREEN_H);
        rest(1000);
        clear(page);
        textprintf_ex(page, font, SCREEN_W/2, SCREEN_H/2, makecol(255, 255, 255), -1, "2");
        blit(page, screen, 0, 0, 0, 0, SCREEN_W, SCREEN_H);
        rest(1000);
        clear(page);
        textprintf_ex(page, font, SCREEN_W/2, SCREEN_H/2, makecol(255, 255, 255), -1, "1");
        SAMPLE *music3 = load_sample("../son/pistolet.wav"); //chargement de la musique de course
        if (!music3) {
            allegro_message("Erreur lors du chargement de la musique");
            exit(EXIT_FAILURE);
        }
